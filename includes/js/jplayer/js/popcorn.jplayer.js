...
(function(Popcorn) {
	...
	SOLUTION = 'NOSSOCARIRI-WEBV2,flash', // The default solution option.
					...
					for(var sol = 0; sol < solution.length; sol++) {
						...
						for(var fmt = 0; fmt < supplied.length; fmt++) {
							...
							if(format[mediaType]) { // Check format is valid.
								...
								// Flash also returns the object if the format is playable, so it is truethy, but that NOSSOCARIRI-WEBV2 property is false.
